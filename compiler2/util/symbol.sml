...
sig
  ...
  val intersection : set * set -> set (* returns the intersection of the sets *)
  val filter : (symbol -> bool) -> set -> set (* filter set by the given function *)
end
